# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-05-07 06:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdby', models.CharField(blank=True, db_column='CreatedBy', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_ar', models.IntegerField(db_column='Name_Ar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taskdesc', models.CharField(blank=True, db_column='TaskDesc', max_length=400, null=True, verbose_name='Task Descreption')),
                ('taskcount', models.IntegerField(blank=True, db_column='TaskCount', null=True)),
                ('tasktype', models.CharField(choices=[('', 'Choice type'), ('m', 'Master'), ('h', 'Help')], db_column='TaskType', max_length=1, verbose_name='Task type')),
                ('duration', models.IntegerField(blank=True, db_column='Duration', null=True, verbose_name='Duration')),
                ('durationhoure', models.IntegerField(blank=True, db_column='DurationHoure', null=True)),
                ('createddate', models.DateTimeField(blank=True, db_column='CreatedDate', null=True)),
                ...
                ('submit', models.NullBooleanField(db_column='submit')),
